...
## Current: 3-day push/pull/legs, reduced volume
...
- PPL hits each muscle once a week; 3-day full-body would hit each three times, which
  is generally better for a beginner. PPL was chosen for focus and session clarity.
- If a fourth day is added, PPL becomes a much stronger fit.
